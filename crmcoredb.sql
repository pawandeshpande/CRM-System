...
ALTER TABLE CRM_ACCOUNT ADD FOREIGN KEY (ACCOUNT_TYPE_ID) REFERENCES CRM_ACCOUNT_TYPE(ROW_ID);
...
INSERT INTO CRM_USERS(NAME ,
 ...
 TENANT_ID, 
 ACTIVE_FLG,
 DELETED_STATE ) VALUES("Test Admin1", "TestAdmin1", password('P@ssword1'), curdate(), -1, curdate(), -1, 1,'Y','N'); 
